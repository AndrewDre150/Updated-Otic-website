...
const Footer = () => {
  return (
    ...
    {/* <div style={{width:'80vw',display:'flex' ,textAlign:'center', color:'white',
  backdropFilter:'blur(20px)',marginLeft:'10vw', backgroundColor:'rgba(230, 229, 255, 0.25)'}}>
      <div style={{width:'20px'}}></div> */}
      <div className='footer-copyright'>
      &copy; &nbsp;<span style={{color:'orange'}}>Otic  &nbsp;</span>2023. All Rights Reserved.
...
//   marginLeft:'10vw', 
//   backgroundColor:'rgba(230, 229, 255, 0.25)'
//   }}