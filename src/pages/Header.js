...
function Navbar(){
    ...
    return(
        <div>
            <nav className="nav">
                <div>
            <img className='icon'  src='rectangle-34624134@2x.png' style={{marginBottom: '10px'}}></img>
                </div>
                <ul className={active}>
                    ...
                    <li className="nav__item"><a href="#newsupdates" className="nav__link">News and Updates</a></li>
                    <li className="nav__item"><a href="#contact-footer" className="nav__link">Contact Us</a></li>
                  
                    {user ? <li className="nav__item" style={{marginLeft:'0px'}}><a onClick={Logout} href="#" className="nav_link">Logout</a></li> : <li><a onClick={googleSignIn} href="#"  className="nav_link">Login </a></li> }
